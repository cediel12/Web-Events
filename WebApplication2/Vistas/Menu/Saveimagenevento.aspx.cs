...
{
    public partial class Saveimagenevento : System.Web.UI.Page
    {
        ...
        protected void subirarchivo(object sender, EventArgs e)
        {
            ...
            if (fileupload1.HasFile)
            {
                ...
                if (u.actualizarimagenevento("imagen de" + Session["Nombre"].ToString(), fileupload1.FileName, "2018-05-24", 1, Int32.Parse(Session["ideventoimagen"].ToString())))
                {
