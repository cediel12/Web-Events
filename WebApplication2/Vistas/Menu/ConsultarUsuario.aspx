<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Menu/Administrador.Master" AutoEventWireup="true" CodeBehind="ConsultarUsuario.aspx.cs" Inherits="PaginaWeb.Vistas.Menu.ConsultarUsuario" %>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>                        
                        ...
                        <tr>
                            ...
                            <td><%=drconsulta["usuario"].ToString().ToUpper() %></td>
                        </tr>
                            <%} %>
                    </tbody>
                    <!--Table body-->
